...
public class Player{
    ...
    private DABigInteger z = DABigInteger.ZERO();
    ...
    public Player(DNCChain chain, String name) throws IllegalArgumentException, NoSuchAlgorithmException, MPException {
...
/*
    ...
    private DNCLink computeLink(int k, DataField data, byte[] prevChainingValue) {
    ...
    private void buildLink(String info, DataFieldAttribute attr)
    ...
    public void initProtocol() throws MPException, SecurityException {
        assertSeal();
        Digest C_p = null;
        ...
        try {
            ...
            do {
                z_u = new DABigInteger(Z_BITLENGTH, 80, SecureRandom.getInstance("SHA1PRNG"));
            ...
            for (int i = 0; i < s; i++) {
                ...
                DABigInteger eps_i;
                do {
                    eps_i = new DABigInteger(z_u.bitLength(), SecureRandom.getInstance("SHA1PRNG"));
    ...
    public void drawCard(int card) throws IllegalArgumentException, MPException , SecurityException {
        assertSeal();
        try {
            if (!available[card - 1]) {
    ...
    public void processCardDraw() throws IllegalArgumentException, MPException, SecurityException {
        assertSeal(); 
    ...
    public void processSelfCardDraw() throws MPException, SecurityException {
        assertSeal();
    ...
    public void processCardDrawO() throws MPException, SecurityException {
        assertSeal();
        DABigInteger z_i = null;
        EncryptedCardVector ew_i = null;
        PHIntVector d = null;
    ...
    public void finishCardDraw() throws MPException, SecurityException {
        assertSeal();
        boolean ok  = false;
        try {
...
//            throw new MPException();
    ...
    public BigIntVector revealPrivateKey() {
        unseal();
    ...
    public byte[] revealPermutation() {
        unseal();
        this.rPerm = DeclassifyHelper.declassifyByteArray(p);
        return rPerm;
    }

    public PermutationMatrix revealMatrix() {
        unseal();
    ...
    public boolean validate(BigIntVector oKey, byte[] oPerm, PermutationMatrix oMatrix)
            throws IllegalArgumentException, MPException {
        if (oKey == null)
        ...
        PHCrypto oph = null;
        try {
            oph = new PHCrypto(this.nlength, (DABigInteger)oKey.get(0), (DABigInteger)oKey.get(1),
                (DABigInteger)oKey.get(2), (DABigInteger)oKey.get(3));
        } catch (IndexOutOfBoundsException ignored) {
            return false;
