...
// import instruction is needed by ESC/Java to refer to _transactionDepth
...
public class Decimal extends Object{
    ...
    /** catch an decimal exception */
    private DecimalException decimal_exception = new DecimalException();
    ...
    */
    ...
    /*@    
      invariant decPart_ >= 0 && decPart_ < PRECISION ;
      invariant intPart_ >= 0 ;
      invariant intPart_ == MAX_DECIMAL_NUMBER ==> decPart_ == 0;
    */
    ...
    */ 
	...
	throws ISOException  {
        ...
        try{
            ...
            //@ unreachable;
            ISOException.throwIt((short)0x9F15/*DECIMAL_OVERFLOW*/);			
        }
    }
...
// 	return this;
    ...
    */ 
    ...
    public short setValue(byte buffer[], short d) throws DecimalException {
	return d ;
    }
    ...
    */
	...
	throws TransactionException,
        ...
        short resu = off;
        resu  = Util.setShort(bArray,resu,intPart);        
        resu  = Util.setShort(bArray,resu,decPart);
        return resu;
    }
