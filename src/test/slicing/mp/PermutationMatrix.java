...
/*
	public PermutationMatrix(byte[] p, int z){// throws (IllegalArgumentException{L}, NoSuchAlgorithmException{L},MPException{L}){
//        if (z == null)
//            throw new IllegalArgumentException("z is null");
//        if (p == null)
//            throw new IllegalArgumentException("p is null");
        matrix = new BigIntVector();
        if (p == null || z==0) return;// == null) return;
			...
			for (int i = 0; i < t; i++) {
				...
				for (int j = 0; j < t; j++) {
					...
					if (j != p[i] - 1) {
						int k;
						do {
							k = new DABigInteger(z.bitLength(),new Random());// SecureRandom.getInstance("SHA1PRNG"));
...
*/
    ...
    public boolean validate(byte[] p, int z){ // throws IllegalArgumentException, MPException {
//        if (z == null)
//            throw new IllegalArgumentException("z is null");
//        if (p == null)
//            throw new IllegalArgumentException("p is null");
...
//                        }
                        ...
                        if (P_ij%z==0)//P_ij.mod(z).compareTo(DABigInteger.ZERO()) == 0)
                           return false;
                    }
                }
            }
...
//		} catch (NoSuchAlgorithmException e) { throw new MPException("NSA");
//		} catch (NullPointerException e) { throw new MPException("NPE");
//        } catch (ClassCastException e) { throw new MPException("CCE"); } 
		return NULL;
	}
	*/
/*
    public void setNonZero(int i, DABigInteger z){ // throws (MPException, IllegalArgumentException, IndexOutOfBoundsException) {
        ArrayList matrix = this.matrix;
//        if (matrix == null)
