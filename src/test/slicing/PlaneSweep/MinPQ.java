...
public class MinPQ{//<Key> implements Iterable<Key> {
    private Event[] pq;                    // store element at indices 1 to N
    private int N;                       // number of elements on priority queue
//    private Comparator<Event> comparator;  // optimal comparator
   ...
   /**
     ...
     */
/*    public MinPQ(int initCapacity, Comparator<Event> comparator) {
...
*/
   /**
     ...
     */
//    public MinPQ(Comparator<Event> comparator) { this(1, comparator); }
...
/*        if (comparator == null) {
            return ((Comparable<Event>) pq[i]).compareTo(pq[j]) > 0;
        }
        else {
